...
```bash
$ cortex install novo-design-static --save
```
...
```js
var novo_design_static = require('novo-design-static');
```
...
### Class: novo_design_static(options)
<!-- 
...
Creates a new novo-design-static instance.
...
### novo-design-static.\<method-name\>(arguments)
